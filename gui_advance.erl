...
file_info_page(Notebook) ->
    ...
    wxSizer:add(FileGridSizer, FPathText1101, [{proportion, 0}, 
						{flag, ?wxALIGN_LEFT}]),
    wxSizer:add(FileGridSizer, PText1102, [{proportion, 0}, 
					     {flag, ?wxALIGN_RIGHT}]),
...
torrent_info_page(Notebook) ->
    ...
    wxSizer:add(TorrentGridSizer, SeedText1202, [{proportion, 0}, 
						 {flag, ?wxALIGN_LEFT}]),
    wxSizer:add(TorrentGridSizer, LeechText1203, [{proportion, 0}, 
						  {flag, ?wxALIGN_RIGHT}]), 
...
peer_page(Notebook) ->
    ...
    PageText3 = wxStaticText:new(Page3, ?wxID_ANY, 
				 "This is a Torrent Info tab.",
				[{pos, {50, 100}}]),
